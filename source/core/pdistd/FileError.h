...
/*
    PDISTD file error codes.

    Split out of what used to be Enums.h, which also held a car-camera enum and
    so dragged it into every file-device translation unit.
*/
typedef enum
{
  FileError_OK = 0x0,
